...
def test_deve_subtratir_valor_da_carteira_do_usuario_quando_este_propor_um_lance(vini, leilao):
...
def test_deve_permitir_propor_lance_quando_o_valor_eh_igual_ao_o_valor_da_carteira(vini, leilao):
